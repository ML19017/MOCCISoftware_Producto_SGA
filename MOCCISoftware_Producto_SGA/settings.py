"""
Django settings for MOCCISoftware_Producto_SGA project.
...
ROOT_URLCONF = 'MOCCISoftware_Producto_SGA.urls'
...
WSGI_APPLICATION = 'MOCCISoftware_Producto_SGA.wsgi.application'
